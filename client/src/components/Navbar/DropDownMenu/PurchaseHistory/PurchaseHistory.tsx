...
const PurchaseHistory = () => {
  ...
  return (
    <div className="p-[5em]">
      <h1 className="mb-[1em] font-sans font-extrabold">Purchase history</h1>
      <div className="flex flex-row items-start justify-start gap-[1em]">
        <h3 className="mt-[1em] font-sans font-extrabold">Courses</h3>
        <h3 className="mt-[1em] font-sans font-extrabold">Subscriptions</h3>
        <h3 className="mt-[1em] font-sans font-extrabold">Refunds</h3>
      </div>
      <hr />
      <div>
        <div className="mt-[1.5em] flex flex-row items-center justify-center gap-[10em]">
          ...
          <div>
            <h3 className="font-sans font-extrabold">Total price</h3>
          </div>
          <div>
            <h3 className="font-sans font-extrabold">Payment type </h3>
          </div>
        </div>
        <hr className="mt-[1em]" />
