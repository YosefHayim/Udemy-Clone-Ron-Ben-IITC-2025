      ...
      <div className="relative w-full p-[1em]">
        <div className="flex w-full flex-row items-center justify-between">
          ...
          <div className="flex w-full items-center justify-end gap-[1em]">
            <Button className="bg-white font-sans font-extrabold text-black shadow-none hover:bg-white hover:text-btnColor focus:outline-none">
              Login
            </Button>
            <Button className="h-[3em] rounded-[0.2em] bg-btnColor font-sans font-extrabold text-white shadow-none hover:bg-black focus:outline-none">
              Get started
            </Button>
