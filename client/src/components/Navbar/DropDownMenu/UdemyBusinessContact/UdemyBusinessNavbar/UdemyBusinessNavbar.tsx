      ...
      <div className="relative w-full p-[1em]">
        <div className="flex flex-row items-center justify-between w-full">
          ...
          <div className="flex items-center justify-end gap-[1em] w-full">
            <Button className="focus:outline-none text-black bg-white hover:bg-white shadow-none font-bold hover:text-btnColor">
              Login
            </Button>
            <Button className="focus:outline-none font-bold bg-btnColor text-white shadow-none hover:bg-black rounded-[0.2em] h-[3em]">
              Get started
            </Button>
