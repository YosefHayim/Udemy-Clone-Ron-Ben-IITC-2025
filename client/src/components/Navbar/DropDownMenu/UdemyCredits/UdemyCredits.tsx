...
const UdemyCredits = () => {
  ...
  return (
    <div className="p-[5em]">
      <h1 className="mb-[1em] font-extrabold">Udemy credits</h1>
      <h2 className="text-[1.4em]">
        <span className="mt-[1em] font-extrabold">Your credits:</span> ₪
        {userCredits || 0.0}
      </h2>
      <div>
        <div className="flex w-full flex-row items-center justify-between">
          <div>
            <h3 className="mb-[0.5em] mt-[1em] text-[1.4em] font-extrabold">
          ...
          <div>
            <form className="flex flex-row items-center">
              ...
              ></Input>
              <Button className="rounded-[0.1em] font-extrabold focus:outline-none">
                Redeem
              </Button>
            </form>
          </div>
        ...
        <div className="flex flex-row items-center justify-start gap-[10em]">
          ...
          <div>
            <h3 className="font-extrabold">Amount</h3>
          </div>
          <div>
