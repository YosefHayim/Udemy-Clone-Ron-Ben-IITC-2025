          ...
          <div>
            ...
            <div className="flex flex-col lg:flex-row items-start bg-gray-50 border rounded-lg p-6">
              ...
              <div className="flex-1">
                ...
                <div className="mt-6">
                  <button className="focus:outline-none px-6 py-2 bg-purple-600 text-white rounded-md shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 mr-4">
                    Subscribe
                  </button>
                  <button className="focus:outline-none px-6 py-2 border rounded-md shadow-md text-purple-600 hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500">
                    Learn more
                  </button>
                </div>
                <p className="mt-4 text-sm text-gray-500">
                  Starting at €66.67 per month after 7-day trial. Cancel
                  anytime.
                </p>
              </div>
