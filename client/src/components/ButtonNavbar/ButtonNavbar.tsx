...
import { DropdownMenuPopup } from '../DropDownMenuPopup/DropDownMenuPopup';
...
const ButtonNavbar: React.FC<{
  ...
  to: string;
}> = ({ buttonName, paragraphText, to, insideBtnText }) => {
...
// const ButtonNavbar: React.FC<{ buttonName: string }> = ({
//   buttonName,
//   paragraphText,
//   to,
//   insideBtnText,
...
//               <DropdownMenuPopup setState={setIsHovering} hoverState={isHovering}>
