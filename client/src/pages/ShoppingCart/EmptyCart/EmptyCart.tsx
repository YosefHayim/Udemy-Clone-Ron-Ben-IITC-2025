...
const EmptyCart: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      <h2 className="font-extrabold">{totalCoursesInCart} Courses in Cart</h2>
      <div className="flex w-full flex-col items-center justify-center border border-b-gray-100 p-[2em]">
        ...
        <div className="flex flex-col items-center justify-center gap-[1em]">
          ...
          <Button className="cursor-pointer rounded-[0.2em] bg-btnColor py-[1.6em] text-[1.2em] font-extrabold text-white hover:bg-btnHoverColor focus:outline-none">
