  ...
  return (
    <div className="p-[3em]">
      <div className="flex flex-col items-center justify-center">
        <h1 className="text-[1.3em] font-bold">Close Account</h1>
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="w-[500px] text-start">
          ...
          <div className="mt-[1em]">
            <Button className="mr-4 rounded-[0.2em] bg-btnColor px-[1em] py-[1.5em] font-bold text-white shadow-md hover:bg-[#892de1] focus:outline-none focus:outline-none focus:ring-2 focus:ring-purple-500">
              Close account
            </Button>
          </div>
        </div>
