...
const ProfileMain = () => {
  return (
    <div className="flex min-h-screen bg-gray-100 mx-[6rem] mt-[1.5rem] mb-[3rem]">
      ...
      {/* Main Content */}
      <main className="flex-1  border border-gray-800 ">
        <div className="bg-white shadow-lg rounded-lg">


          <div className="border-b border-gray-800 min-w-full text-center p-4">
          ...
          <form className="space-y-6 px-8">
            {/* First Name */}
            <div>
              <p className="font-sans font-bold text-[1rem] pb-2 pt-8">Basics:</p>
              <input
                id="firstName"
                type="text"
