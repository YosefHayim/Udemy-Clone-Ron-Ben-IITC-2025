    ...
    <>
      <div className="rounded-lg bg-white p-6 ">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          <span className="font-semibold">“Udemy,” “we,” “us”</span>) respect
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          applications, APIs, or related services (the{" "}
          <span className="font-semibold">“Services”</span>). It also applies to
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  need to create a user account, which requires us to collect
                  and store your email address, password, and account settings.
                  To create an instructor account, we collect and store your
                  name, email address, password, and account settings. As you
                  use certain features on the site, you may be prompted to
                  submit additional information. For example, you may choose to
                  provide information relevant to your learning interests,
                  including occupation and skill interests, and if you apply to
                  become an instructor, we may collect government ID
                  information, verification photo, date of birth,
                  race/ethnicity, and phone number. Upon account creation, we
                ...
                <td className="border border-gray-300 p-3">
                  <ul className="list-inside list-disc">
                    ...
                    <li>
                      ...
                      verification, fraud prevention and security,
                      communication)
                    </li>
                  </ul>
                </td>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  media profiles, country, or other data. Your Profile Data will
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  share content publicly, including by uploading courses and
                  other educational content, posting reviews about content,
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  When you access content, we collect certain data including
                  which courses, assignments, labs, workspaces, and quizzes
                  you’ve started and completed; content and subscription
                  purchases and credits; subscriptions; completion certificates;
                  your exchanges with instructors, teaching assistants, and
                  other students; and essays, answers to questions, and other
                  items submitted to satisfy course and related content
                  requirements.
                </td>
                <td className="border border-gray-300 p-3">
                  <ul className="list-inside list-disc">
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  saved to process future orders. You must provide certain
                  payment and billing data directly to our payment service
                  providers, including your name, credit card information,
                  billing address, and ZIP code. We may also receive limited
                  information, like the fact that you have a new card and the
                  last four digits of that card, from payment service providers
                  to facilitate payments. For security, Udemy does not collect
                  or store sensitive cardholder data, such as full credit card
                ...
                <td className="border border-gray-300 p-3">
                  <ul className="list-inside list-disc">
                    ...
                    <li>
                      Legitimate interests (payment facilitation, fraud
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  If you are an instructor, you can link your PayPal, Payoneer,
                  or other payment account to the Services to receive payments.
                  When you link a payment account, we collect and use certain
                  information, including your payment account email address,
                  account ID, physical address, or other data necessary for us
                  to send payments to your account. In some instances, we may
                  collect ACH or wire information to send payments to your
                  account. In order to comply with applicable laws, we also work
                  with trusted third parties who collect tax information as
                  legally required. This tax information may include residency
                  information, tax identification numbers, biographical
                  information, and other personal information necessary for
                  taxation purposes. For security, Udemy does not collect or
                  store sensitive bank account information. The collection, use,
                  and disclosure of your payment, billing, and taxation data is
                  subject to the privacy policy and other terms of your payment
                  account provider.
                </td>
                <td className="border border-gray-300 p-3">
                  <ul className="list-inside list-disc">
                    ...
                    <li>Legal obligation</li>
                    <li>
                      Legitimate interests (service provisioning, payment
                      facilitation, fraud prevention and security, compliance)
                    </li>
                  </ul>
                </td>
              </tr>
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  other online accounts if they are connected to your Udemy
                  account. If you login to Udemy via Facebook or another
                  third-party platform or service, those platforms and services
                  make information available to us through their APIs. The
                  information we receive depends on what information you (via
                  your privacy settings) or the platform or service decide to
                  give us and usually consists of your first and last name, user
                  identification number, and email address. If you access or use
                  our Services through a third-party platform or service, or
                  click on any third-party links, the collection, use, and
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  location, Udemy user ID, refund transaction IDs, and any other
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  unique device identifiers, browser, browser language, domain
                  and other systems data, and platform types.
                </td>
                <td className="border border-gray-300 p-3">
                  <ul className="list-inside list-disc">
                    <li>Performance of contract</li>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-3">
                  ...
                  including content accessed, time spent on pages or the
                  Service, pages visited, features used, your search queries,
                  click data, date and time, referrer, and other data regarding
                  your use of the Services.
                </td>
                <td className="border border-gray-300 p-3">
                  <ul className="list-inside list-disc">
                    <li>
                      Legitimate interests (service provisioning, user
                      experience improvement, product improvement)
                    </li>
                  </ul>
                </td>
              </tr>
      ...
      <div className="mx-auto max-w-5xl rounded-2xl bg-white p-6 text-gray-900">
        ...
        <p className="mb-4">
          ...
          including on Udemy. They allow us to remember things about your visits
          to Udemy, like your preferred language, and to make the site easier to
          use. To learn more about cookies, visit{" "}
          <a
          ...
          . We may also use clear pixels in emails to track deliverability and
          open rates.
        </p>
        <p className="mb-4">
          Udemy and service providers acting on our behalf (like Google
          ...
          (together, <strong>“Data Collection Tools”</strong>) when you access
          and use the Services. These Data Collection Tools automatically track
          and collect certain System Data and Usage Data (as detailed in Section
          1) when you use the Services. In some cases, we tie data gathered
          through those Data Collection Tools to other data that we collect as
        ...
        <p className="mb-4">
          Udemy uses the following types of Data Collection Tools for the
          purposes described:
        </p>
        <ul className="list-inside list-disc space-y-4 pl-4">
          <li>
            <strong>Strictly Necessary:</strong> These Data Collection Tools
            enable you to access the site, provide basic functionality (like
            logging in or accessing content), secure the site, protect against
            fraudulent logins, and detect and prevent abuse or unauthorized use
            of your account. These are required for the Services to work
            properly, so if you disable them, parts of the site will break or be
            unavailable.
          </li>
          <li>
            <strong>Functional:</strong> These Data Collection Tools remember
            data about your browser and your preferences, provide additional
            site functionality, customize content to be more relevant to you,
            and remember settings affecting the appearance and behavior of the
            Services (like your preferred language or volume level for video
            playback).
          </li>
          <li>
            <strong>Performance:</strong> These Data Collection Tools help
            measure and improve the Services by providing usage and performance
            data, visit counts, traffic sources, or where an application was
            downloaded from. These tools can help us test different versions of
            Udemy to see which features or content users prefer and determine
            which email messages are opened.
          </li>
          <li>
            <strong>Advertising:</strong> These Data Collection Tools are used
            to deliver relevant ads (on the site and/or other sites) based on
            things we know about you like your Usage and System Data (as
            detailed in Section 1), and things that the ad service providers
            know about you based on their tracking data. The ads can be based on
            your recent activity or activity over time and across other sites
            and services. To help deliver tailored advertising, we may provide
            these service providers with a hashed, anonymized version of your
            email address (in a human-readable form) and content that you share
            publicly on the Services.
          </li>
          <li>
            <strong>Social Media:</strong> These Data Collection Tools enable
            social media functionality, like sharing content with friends and
            networks. These cookies may track a user or device across other
            sites and build a profile of user interests for targeted advertising
            purposes.
          </li>
        </ul>
        <p className="mt-4">
          You can set your web browser to alert you about attempts to place
          cookies on your computer, limit the type of cookies you allow, or
      ...
      <div className="mx-auto max-w-5xl rounded-2xl bg-white p-6 text-gray-900">
        ...
        <ul className="list-inside list-disc space-y-4 pl-4">
          ...
          <li>
            ...
            <ul className="list-inside list-disc space-y-2 pl-4">
              ...
              <li>
                ...
                notifications about changes to our Services; and updates to our
                agreements;
              </li>
              <li>
                Sending you information, such as by email or text messages,
                about your progress in courses and related content, rewards
                programs, new services, new features, promotions, newsletters,
                and other available instructor-created content (which you can
          ...
          <li>
            ...
            features (all data categories), including through the use of AI
            consistent with the{" "}
        ...
        <p className="mt-4">
          We may process your inputs into the AI Assistant chatbot or other
          generative artificial intelligence (GenAI) features using GenAI in
          order to respond to your question or request, but we do not use your
          personal data to train or fine-tune GenAI models.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-5xl rounded-2xl bg-white p-6 text-gray-900">
        ...
        <p className="mb-4">
          ...
          of a corporate restructuring. Lastly, we can share data in other ways
        ...
        <ul className="list-inside list-disc space-y-4 pl-4">
          <li>
            ...
            assistants for educational content you access or request information
            about, so they can improve their content for you and other students.
            This data may include things like your country, browser language,
            operating system, device settings, the site that brought you to
            Udemy, and certain activities on Udemy, like enrolled courses and
            course review. We will not share your email address with instructors
            or teaching assistants. (Account Data; System Data; Usage Data;
            Approximate Geographic Data)
          </li>
          <li>
            <strong>With Other Students and Instructors:</strong> Depending on
            your settings, your Shared Content and profile data may be publicly
          ...
          <li>
            ...
            our behalf, like payment processing, fraud and abuse prevention,
            data analysis, advertising services (including retargeted
          ...
          <li>
            <strong>With Udemy Affiliates:</strong> We may share your data
            within our corporate family of companies that are related by common
            ownership or control, to enable or support us in providing the
            Services. (All data categories)
          </li>
          <li>
            <strong>With Business Partners:</strong> We have agreements with
            other websites and platforms to distribute our Services and drive
            traffic to Udemy. Depending on your settings, we may share your data
            with these trusted partners. (Account Data; Learning Data;
            Communications and Support; System Data)
          </li>
          <li>
            <strong>
              With Credit-Granting Organizations for Continuing Education:
            </strong>{" "}
            ...
            organization that provided you the credit. (Account Data; Learning
            Data)
          </li>
          <li>
            <strong>With Analytics and Data Enrichment Services:</strong> As
            part of our use of third-party analytics tools like Google Analytics
            and data enrichment services like Infutor, we share certain contact
            information or de-identified data, as data like this helps improve
            our Services. We provide things like your name and email address and
            usage data to enrich data. This allows these providers to provide
            analytics services or match data with publicly available databases.
            (Account Data; Data About Your Accounts on Other Services; System
            Data; Usage Data)
          </li>

          <li>
            <strong>To Power Social Media Features:</strong> The social media
            features in the Services (like the Facebook Like button) may allow
            the third-party social media provider to collect things like your IP
          ...
          <li>
            <strong>To Administer Promotions and Surveys:</strong> We may share
          ...
          <li>
            <strong>For Advertising:</strong> If we decide to use an
            advertising-supported revenue model in the future, we may use and
            share certain System Data and <strong>Usage Data</strong> with
            third-party advertisers and networks to show general demographic and
            preference information among our users. We may also allow
            advertisers to collect System Data through Data Collection Tools (as
            detailed in Section 2.1), to use this data to offer you targeted ad
            delivery to personalize your user experience (through behavioral
            advertising) and to undertake web analytics. Advertisers may also
            share with us the data they collect about you. To learn more or opt
            out from participating at networks’ behavioral advertising, see
            Section 6.1 (Your Choices About the Use of Your Data) below. Note
            that if you opt out, you’ll continue to be served generic ads.
            (System Data)
          </li>
          <li>
            <strong>For Security and Legal Compliance:</strong> We may disclose
            your data (all data categories) to third parties if we (in our sole
          ...
          <li>
            ...
            harm to the rights, property, or safety of Udemy, our users,
          ...
          <li>
            <strong>During a Change in Control:</strong> If Udemy undergoes a
            business transaction like a merger, acquisition, corporate
            divestiture, or dissolution (including bankruptcy), or a sale of all
            or some of its assets, we may share, disclose, or transfer all of
            your data to the successor organization during such transition or in
            contemplation of a transaction (including during due diligence).
            (All data categories)
          </li>
          <li>
            <strong>After Aggregation/De-identification:</strong> We may
            disclose or use aggregated or de-identified data for any purpose.
          </li>
          <li>
            <strong>With Your Permission:</strong> With your consent, we may
            share data to third parties outside the scope of this Privacy
            Policy. (All data categories)
          </li>
          <li>
            <strong>To Power Social Media Features:</strong> The social media
            features in the Services (like the Facebook Like button) may allow
        ...
        <p className="mt-4">
          If you click on any links to third-party sites, the collection, use,
          and disclosure of your personal data is governed by the third-party’s
          privacy policy.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-6 text-gray-900">
        ...
        <p className="mb-4">
          Udemy takes appropriate security measures to protect against
          ...
          between you and Udemy, the Services, or any information provided to us
          in connection with the data we collect through the Services will be
          free from unauthorized access by third parties. Your password is an
      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-6 text-gray-900 shadow-lg">
        ...
        <ul className="list-inside list-disc space-y-4 pl-4">
          <li>
            ...
            . Note that regardless of your email preference settings, we will
            send you transactional and relationship messages regarding the
            Services, including administrative confirmations, order
            confirmations, important updates about the Services, and notices
            about our policies.
          </li>
          <li>
          ...
          <li>
            ...
            . Your wireless device may also allow you to control whether
          ...
          <li>
            ...
            <a
              href="https://www.japan-ima.org/"
              className="text-blue-600 underline"
            >
              Digital Advertising Consortium
            </a>
            . To opt out of Google’s display advertising or customize Google
          ...
          <li>
            ...
            settings on those devices or systems.
          </li>
        </ul>
        <p className="mt-4">
      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-6 text-gray-900 shadow-lg">
        ...
        <p className="mb-4">
          You can access and update your personal data that Udemy collects and
        ...
        <ul className="list-inside list-disc space-y-4 pl-4">
          ...
          <li>
            ...
            <ul className="list-inside list-disc space-y-2 pl-4">
              <li>
                If you are a student, visit your profile settings page and
          ...
          <li>
            ...
            or writing to us at Udemy, Attn: Privacy/Legal Team, 600 Harrison
            Street, 3rd floor, San Francisco CA 94107. Please allow up to 30
            days for a response. For your protection, we may require that the
        ...
        <p className="mb-4">
          Parents who believe that Udemy may have collected personal data from a
      ...
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-md">
        ...
        <ul className="mb-4 list-inside list-disc space-y-2">
          <li>
            <strong>“Right to Know”</strong> — You have the right to request to
            know more about the categories and specific pieces of personal
            information that we have collected about you and access a copy of
            your personal information.
          </li>
          <li>
            <strong>“Right to Correction”</strong> — You have the right to have
            inaccurate personal information about you corrected.
          </li>
          <li>
            <strong>“Right to Deletion”</strong> — You have the right to request
            deletion of personal information that we have collected about you.
          </li>
          <li>
            <strong>“Right to Non-Discrimination”</strong> — If you choose to
            exercise any of your rights under CCPA, Udemy will treat you like
            all other users. In other words, there is no penalty for exercising
        ...
        <p className="mb-4">
          CCPA has a specific definition of a “sale” and “sharing” and while
          Udemy does not, in the traditional sense, sell your personal
          information or the personal information of any of our users, we do use
          cookies that make non-personally identifiable information available to
          select third-parties, including for cross-context advertising. To opt
          out of such a “sale” and “sharing,” click on the “Do Not Sell or Share
        ...
        <p className="mb-4">
          ...
          or write to us at Udemy, Attn: Privacy/Legal Team, 600 Harrison
          Street, 3rd floor, San Francisco CA 94107. CCPA allows you to
          designate an authorized agent to make these requests on your behalf.
          For your protection, we may require that the request be sent through
          the email address associated with your account, and we may need to
          verify you and/or your agent’s identity before fulfilling your
          request.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          with the phrase “California Shine the Light” and include your mailing
          address, state of residence, and email address.
        </p>
        <p className="mb-4">
      ...
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-md">
        ...
        <p className="mb-4">
          ...
          (“OAIC”). You can contact OAIC by visiting{" "}
          ...
          ; telephoning 1300 363 992; or writing to OAIC at GPO Box 5218, Sydney
          NSW 2001. You may contact our privacy team at{" "}
          <a
            href="mailto:privacy@udemy.com"
            className="text-blue-500 underline"
          >
          ...
          to make a complaint about a breach of the Australian Privacy
        ...
        <p className="mb-4">
          ...
          processing of your personal data. You may use the information in
          Section 6.2 to submit your request. Additionally, if you are located
          in the EEA, UK, or Switzerland, you also have the right to lodge a
          complaint with your supervisory authority.
        </p>
        <p className="mb-4">
          Personal data is also processed outside of the UK, Switzerland, and
          the EEA by our Udemy group companies, or our service providers,
          ...
          agreements with our service providers and Udemy group companies to
      ...
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-md">
        ...
        <p className="mb-4">
          Udemy, Inc. complies with the EU-U.S. Data Privacy Framework (EU-U.S.
          ...
          of Commerce. Udemy, Inc. has certified to the U.S. Department of
          Commerce that it adheres to the EU-U.S. Data Privacy Framework
          Principles (EU-U.S. DPF Principles) with regard to the processing of
          personal data received from the European Union in reliance on the
          EU-U.S. DPF and from the United Kingdom (and Gibraltar) in reliance on
          the UK Extension to the EU-U.S. DPF. Udemy, Inc. has certified to the
          ...
          to the processing of personal data received from Switzerland in
          ...
          Swiss-U.S. DPF Principles, the DPF Principles shall govern. To learn
        ...
        <p className="mb-4">
          The Federal Trade Commission has jurisdiction over Udemy Inc.’s
        ...
        <p className="mb-4">
          ...
          received from the European Union, UK and Gibraltar, and Switzerland.
          The types of personal data collected are described in Section 1 of
          this Privacy Policy. The purposes for which we collect and use
          personal data are described in Section 3 of this Privacy Policy. The
          type of third parties to whom we disclose personal data are described
          in Section 4 of this Privacy Policy. We remain responsible for any of
          your personal data that is shared under the Onward Transfer Principle
          with third parties to further processing on our behalf. Additionally,
          ...
          law enforcement requirements. Udemy, Inc. shall remain liable under
          the DPF Principles if its agent processes personal data in a manner
          inconsistent with the DPF Principles, unless Udemy, Inc. proves that
        ...
        <p className="mb-4">
          ...
          instructions on doing so are provided in Section 6.2 of this Privacy
          Policy. Individuals may also limit the use and disclosure of their
          personal data as described in Section 6.1.
        </p>
        <p className="mb-4">
          In compliance with the EU-U.S. DPF, the UK Extension to the EU-U.S.
          DPF, and the Swiss-U.S. DPF, Udemy, Inc. commits to resolve DPF
          ...
          reliance on EU-U.S. DPF, the UK Extension to the EU-U.S. DPF, and the
          Swiss-U.S. DPF, should first contact Udemy at{" "}
          <a
            href="mailto:privacy@udemy.com"
            className="text-blue-500 underline"
          >
        ...
        <p className="mb-4">
          In compliance with the EU-U.S. DPF, the UK Extension to the EU-U.S.
          DPF, and the Swiss-U.S. DPF, Udemy, Inc. commits to refer unresolved
          complaints concerning our handling of personal data received in
          reliance on EU-U.S. DPF, the UK Extension to the EU-U.S. DPF, and the
          Swiss-U.S. DPF, to the International Centre for Dispute
          Resolution/American Arbitration Association (ICDR-AAA), an alternative
          dispute resolution provider based in the United States. If you do not
          receive timely acknowledgment of your DPF Principles-related complaint
          from us, or if we have not addressed your DPF Principles-related
          ...
          for more information or to file a complaint. The services of ICDR-AAA
          are provided at no cost to you. Under certain conditions, you may
          invoke binding arbitration for complaints regarding DPF compliance not
          resolved by any of the other DPF mechanisms as more particularly
          detailed here:{" "}
          <a
        ...
        <p className="mb-4">
          ...
          and processing of your data in the United States or other countries as
      ...
      <div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-md">
        ...
        <p className="mb-4">
          ...
          . Any version of this Privacy Policy in a language other than English
          is provided for convenience. If there is any conflict with a
          non-English version, you agree that the English language version will
          control.
        </p>
        ...
        <p className="mb-4">
          ...
          . You can also send postal mail to us at Udemy, Attn: Legal, 600
