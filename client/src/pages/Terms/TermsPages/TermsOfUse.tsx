  ...
  return (
    <>
      <div className="rounded-lg bg-white p-6 ">
        <h1 className="mb-4 text-3xl font-extrabold">Terms of Use</h1>
        <p className="mb-4 text-base font-semibold italic text-gray-800">
          These Terms of Use (<span className="font-extrabold">"Terms"</span>)
          were last updated on November 12, 2024.
        </p>
        ...
        <p className="mb-4 text-base font-extrabold text-courseNameColorTxt">
          ...
          THE RIGHT TO PARTICIPATE IN ANY CLASS ACTIONS AND TO HAVE CLAIMS
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          to all your activities on the Udemy website, the Udemy mobile
      ...
      <div className="rounded-lg bg-white p-6 ">
        <h3 className="mb-4 text-2xl font-extrabold">1. Accounts</h3>
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            ...
            . You must have reached the age of consent for online services in
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          account login credentials. You must notify us immediately upon
          learning that someone else may be using your account without your
          permission (or if you suspect any other security incident) by
          contacting our{" "}
          <a href="#" className="text-blue-600 underline">
            Support Team
          </a>
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          live (for example, 13 in the US or 16 in Ireland), you may not set up
          an account, but we encourage you to invite a parent or guardian to
          ...
          may not create a Udemy account or use the Services, regardless of
          parental or guardian assistance or consent. If we discover that you
          have created an account that violates these rules, we will terminate
          your account. Under our{" "}
          <a href="#" className="text-blue-600 underline">
            Instructor Terms
          </a>
          , you may be requested to verify your identity before you are
          authorized to submit content for publication on Udemy.
        </p>
        <p className="text-base text-gray-700">
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            ...
            transfer or resell content in any way. We generally grant you a
            lifetime access license, except when we must disable the content
            because of legal or policy reasons or for enrollments via
            Subscription Plans.
          </p>
        </div>
        <p className="mb-4 text-base text-gray-700">
          ...
          , when instructors publish content on Udemy, they grant Udemy a
          license to offer a license to the content to students. This means that
          we have the right to sublicense the content to enrolled students. As a
          student, when you enroll in a course or other content, whether it’s
          free or paid content, you are getting a license from Udemy to view the
          content via the Udemy platform and Services, and Udemy is the licensor
          of record. Content is licensed, and not sold, to you. This license
          does not give you any right to resell the content in any manner
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          permission to do so in a written agreement signed by a Udemy
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          or if we determine it violates our{" "}
          <a href="#" className="text-blue-600 underline">
            Trust & Safety Guidelines
          </a>
          . This lifetime access license does not apply to enrollments via
          Subscription Plans or to add-on features and services associated with
          the course or other content you enroll in. For example, instructors
          may decide at any time to no longer provide teaching assistance or Q&A
          services in association with the content. To be clear, the lifetime
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          offered on the Udemy website may not be exactly the same as the price
          offered on our mobile or TV applications, due to mobile platform
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          wallet) for those fees. Udemy works with payment service providers to
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          Subscription Plan purchases, which are covered in Section 8.4
          ...
          for certain legal or policy reasons, you are entitled to a refund
          beyond this 30-day limit. Udemy also reserves the right to refund
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          due to your violation of these Terms or our{" "}
          <a href="#" className="text-blue-600 underline">
            Trust & Safety Guidelines
          </a>
          , you will not be eligible to receive a refund. Additional information
          on our refund policy is available{" "}
          <a href="#" className="text-blue-600 underline">
            here
          </a>
          .
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          refunded for cash, unless otherwise specified in the terms included
          with your codes or as required by applicable law. Gift and promotional
          codes offered by a partner are subject to that partner’s refund
          policies. If you have multiple saved credit amounts, Udemy may
          determine which of your credits to apply to your purchase. Check out
          our Support Page and any terms included with your codes for more
          details.
        </p>
      </div>
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            ...
            and the law, and respect the intellectual property rights of others.
            We can ban your account for repeated or major offenses. If you think
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          someone else), we may remove your content from our platform. Udemy
          complies with copyright laws. Check out our{" "}
          <a href="#" className="text-blue-600 underline">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          Services or ban your account at any time, with or without notice, for
          any or no reason, including for any violation of these Terms, if you
          fail to pay any fees when due, for fraudulent chargeback requests,
          upon the request of law enforcement or government agencies, for
          extended periods of inactivity, for unexpected technical issues or
          problems, if we suspect that you engage in fraudulent or illegal
          activities, or for any other reason in our sole discretion. Upon any
          such termination we may delete your account and content, and we may
        ...
        <p className="text-base text-gray-700">
          ...
          property rights of others. For more details on how to file a copyright
          or trademark infringement claim with us, see our{" "}
          <a href="#" className="text-blue-600 underline">
            Intellectual Property Policy
          </a>
          .
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          have over your content. If you are an instructor, be sure to
          understand the content licensing terms that are detailed in the{" "}
          <a href="#" className="text-blue-600 underline">
            Instructor Terms
          </a>
          .
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          individuals who partner with Udemy for the syndication, broadcast,
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            ...
            interact, some things can go wrong, and you use Udemy at your own
            risk.
          </p>
        </div>
        <p className="mb-4 text-base text-gray-700">
      ...
      <div className="rounded-lg bg-white p-6 ">
        <h3 className="mb-4 text-2xl font-extrabold">7. Udemy’s Rights</h3>
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          of Udemy and its licensors. Our platforms and services are protected
          by copyright, trademark, and other laws of both the United States and
          foreign countries. Nothing gives you a right to use the Udemy name or
          any of the Udemy trademarks, logos, domain names, and other
          distinctive brand features. Any feedback, comments, or suggestions you
          may provide regarding Udemy or the Services is entirely voluntary and
        ...
        <ul className="mb-4 list-inside list-disc space-y-2 text-base text-gray-700">
          <li>
            ...
            technical delivery systems of Udemy’s service providers.
          </li>
          <li>
          ...
          <li>
            ...
            content on the Udemy platform or Services.
          </li>
          <li>
          ...
          <li>
            ...
            falsely appearing as Udemy); or interfere with, or disrupt (or
      ...
      <div className="rounded-lg bg-white p-6 ">
        <h3 className="mb-4 text-2xl font-extrabold">8. Subscription Terms</h3>
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            ...
            By using a Subscription Plan, you agree to the additional terms in
            this section. Note that use of Udemy Business is not subject to
            these Terms, but is instead governed by the agreement between Udemy
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          and conditions, and subject to usage limitations outlined on our{" "}
          <a href="#" className="text-blue-600 underline">
            Support Page
          </a>
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          right to revoke is included in the{" "}
          <a href="#" className="text-blue-600 underline">
            “Content Enrollment and Lifetime Access”
          </a>{" "}
          section.
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          . If you cancel your subscription to a Subscription Plan, your access
          to that Subscription Plan will automatically end on the last day of
          your billing period. On cancellation, you will not be entitled to
          receive a refund or credit of any fees already paid for your
          subscription, unless otherwise required by applicable law. For
          clarity, cancellation of a subscription does not terminate your Udemy
          account.
        </p>
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          and dates of your free trial period, visit our{" "}
          <a href="#" className="text-blue-600 underline">
            Support Page
          </a>
          .
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          to learn more about where to find the fees and dates applicable to
          your subscription. Payments are non-refundable and there are no
          refunds or credits for partially used periods, unless otherwise
        ...
        <p className="text-base text-gray-700">
          ...
          Subscription Plan. We reserve the right to modify or terminate a
          Subscription Plan at our sole discretion. These disclaimers are in
      ...
      <div className="rounded-lg bg-white p-6 ">
        <h3 className="mb-4 text-2xl font-extrabold">9. Generative AI Terms</h3>
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            This section covers additional terms that apply to your use of
            generative AI features in our Services (“GenAI Features”). By
            accessing or using any GenAI Feature, you agree to the additional
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          ownership of the Input and grant Udemy the rights detailed in the{" "}
          <a href="#" className="text-blue-600 underline">
            “Udemy’s Rights to Content You Post”
          </a>{" "}
          section above, allowing us to use the Input in the same manner as the
          other content you submit or post on or through our platform. Udemy
          grants you a limited, non-transferable, non-sublicensable license to
          access and use the GenAI Features and Output in accordance with these
          Terms and solely for your personal, non-commercial, educational
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          generative AI models where we have an appropriate legal basis for
          doing so. In some cases, we may rely on your consent and provide you
          with the ability to withdraw that consent. In other cases, we may rely
          on other legal bases, such as legitimate interest or contractual
        ...
        <ul className="mb-4 list-inside list-disc space-y-2 text-base text-gray-700">
          <li>
            ...
            or regulations, including the infringement, misappropriation, or
          ...
          <li>
            ...
            learning or model training purposes that compete with Udemy.
          </li>
          <li>
            Circumvent any restrictions or protective measures of the GenAI
            Features.
          </li>
          <li>
            Use the GenAI Features or Output to make, or as a substantial factor
            in making, consequential decisions in areas affecting material or
            individual rights or well-being, such as finance, legal,
            educational, employment, healthcare, housing, insurance, or social
            welfare.
          </li>
        </ul>
        <p className="mb-4 text-base text-gray-700">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          reviewing and verifying any Output before relying on it. The Output
          may not be unique and others using the GenAI Features may generate the
          same or similar Output. At any point in the future, we reserve the
          right to limit, suspend, terminate, or otherwise modify your access to
          the GenAI Features at our sole discretion. These disclaimers are in
          addition to those listed in the{" "}
          <a href="#" className="text-blue-600 underline">
            “Disclaimers”
          </a>{" "}
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          Risk), 7 (Udemy’s Rights), 8.5 (Subscription Disclaimers), 9.4 (GenAI
          Feature Disclaimers), 10 (Miscellaneous Legal Terms), and 11 (Dispute
          Resolution).
        </p>
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          recourse to seek damages against us even if you suffer loss or damage
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          to the exclusive jurisdiction of the courts in Delhi, India. If you’re
          located elsewhere, you may be contracting with Udemy, Inc. under
          California law.
        </p>
      </div>
      ...
      <div className="rounded-lg bg-white p-6 ">
        <h3 className="mb-4 text-2xl font-extrabold">11. Dispute Resolution</h3>
        <div className="mb-4 rounded-lg border-l-4 border-blue-600 bg-gray-100 p-4">
          <p className="text-base text-gray-700">
            ...
            Canada, your options are to go to small claims court or bring a
            claim in binding individual arbitration; you may not bring that
            claim in another court or participate in a non-individual class
            action claim against us.
          </p>
        </div>
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          explaining the dispute and a proposal for resolving it to Udemy by
          email at{" "}
          <a
            href="mailto:notices@udemy.com"
            className="text-blue-600 underline"
          >
            notices@udemy.com
          </a>
          , or by certified mail to Udemy Attn: Legal, 600 Harrison Street, 3rd
        ...
        <p className="mb-4 text-base text-gray-700">
          ...
          relief as a court. You and Udemy agree to arbitration as the sole
      ...
      <div className="rounded-lg bg-white p-6 ">
        ...
        <h3 className="mb-4 text-2xl font-extrabold">13. How to Contact Us</h3>
        <p className="mb-4 text-base text-gray-700">
