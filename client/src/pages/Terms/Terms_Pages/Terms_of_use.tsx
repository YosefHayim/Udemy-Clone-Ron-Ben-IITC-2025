    ...
    return (
        <>
            <div className="px-[5rem]">
                ...
                Our website and apps cause communications about your browsing and app activities and app usage to be sent from you to third parties who provide services to Udemy. By using our Services, you consent to these communications.
                ...
                3.1 Pricing
                The prices of content on Udemy are determined based on the terms of the Instructor Terms and our Promotions Policy. In some instances, the price of content offered on the Udemy website may not be exactly the same as the price offered on our mobile or TV applications, due to mobile platform providers’ pricing systems and their policies around implementing sales and promotions.
                ...
                Udemy or our partners may offer gift and promotional codes to students. Certain codes may be redeemed for gift or promotional credits applied to your Udemy account, which then may be used to purchase eligible content on our platform, subject to the terms included with your codes. Other codes may be directly redeemable for specific content. Gift and promotional credits can’t be used for purchases in our mobile or TV applications.
                ...
                4. Content and Behavior Rules
                You can only use Udemy for lawful purposes. You’re responsible for all the content that you post on our platform. You should keep the reviews, questions, posts, courses and other content you upload in line with our Trust & Safety Guidelines and the law, and respect the intellectual property rights of others. We can ban your account for repeated or major offenses. If you think someone is infringing your copyright on our platform, let us know.
                ...
                The content you post as a student or instructor (including courses) remains yours. By posting courses and other content, you allow Udemy to reuse and share it but you do not lose any ownership rights you may have over your content. If you are an instructor, be sure to understand the content licensing terms that are detailed in the Instructor Terms.
                ...
                6. Using Udemy at Your Own Risk
                Anyone can use Udemy to create and publish content and instructors and we enable instructors and students to interact for teaching and learning. Like other platforms where people can post content and interact, some things can go wrong, and you use Udemy at your own risk.
                ...
                7. Udemy’s Rights
                We own the Udemy platform and Services, including the website, present or future apps and services, and things like our logos, API, code, and content created by our employees. You can’t tamper with those or use them without authorization.
                ...
                You may not do any of the following while accessing or using the Udemy platform and Services:

                access, tamper with, or use non-public areas of the platform (including content storage), Udemy’s computer systems, or the technical delivery systems of Udemy’s service providers.
                disable, interfere with, or try to circumvent any of the features of the platforms related to security or probe, scan, or test the vulnerability of any of our systems.
                copy, modify, create a derivative work of, reverse engineer, reverse assemble, or otherwise attempt to discover any source code of or content on the Udemy platform or Services.
                ...
                When using the GenAI Features, you may input or upload content (“Input”). The Services will process the Input to generate output, such as text, provided within the Services (“Output”). You retain ownership of the Input and grant Udemy the rights detailed in the “Udemy’s Rights to Content You Post” section above, allowing us to use the Input in the same manner as the other content you submit or post on or through our platform. Udemy grants you a limited, non-transferable, non-sublicensable license to access and use the GenAI Features and Output in accordance with these Terms and solely for your personal, non-commercial, educational purposes through the Services.

                9.2 No Model Training or Fine-tuning
                Udemy does not use your personal data to train or fine tune generative AI models used for the GenAI Features. If this changes in the future, Udemy will only use your personal data to train or fine tune generative AI models where we have an appropriate legal basis for doing so. In some cases, we may rely on your consent and provide you with the ability to withdraw that consent. In other cases, we may rely on other legal bases, such as legitimate interest or contractual necessity, and provide you with the ability to opt out.
                ...
                use the GenAI Features or Output to develop models or for machine learning or model training purposes that compete with Udemy;
                ...
                You agree that by registering, accessing, or using our Services, you are agreeing to enter into a legally binding contract with Udemy. If you do not agree to these Terms, do not register, access, or otherwise use any of our Services.
                ...
                These Terms (including any agreements and policies linked from these Terms) constitute the entire agreement between you and us (which include, if you are an instructor, the Instructor Terms, Promotions Policy and Instructor GenAI Policy).

                If any part of these Terms is found to be invalid or unenforceable by applicable law, then that provision will be deemed superseded by a valid, enforceable provision that most closely matches the intent of the original provision and the remainder of these Terms will continue in effect.

                Even if we are delayed in exercising our rights or fail to exercise a right in one case, it doesn’t mean we waive our rights under these Terms, and we may decide to enforce them in the future. If we decide to waive any of our rights in a particular instance, it doesn’t mean we waive our rights generally or in the future.

                The following sections shall survive the expiration or termination of these Terms: Sections 2 (Content Enrollment and Lifetime Access), 5 (Udemy’s Rights to Content You Post), 6 (Using Udemy at Your Own Risk), 7 (Udemy’s Rights), 8.5 (Subscription Disclaimers), 9.4 (GenAI Feature Disclaimers), 10 (Miscellaneous Legal Terms), and 11 (Dispute Resolution).
                ...
                Udemy is committed to using its best efforts to resolve disputes with its users, without the need for a formal legal claim to be filed. If an issue arises between us, you and Udemy agree to first work diligently and in good faith to reach a resolution that’s fair and equitable to both sides using the mandatory informal dispute resolution process described below. On occasion, a third party may be necessary to help resolve our dispute. This Dispute Resolution Agreement limits how these disputes can be resolved.

                YOU AND UDEMY AGREE THAT ANY AND ALL DISPUTES, CLAIMS, OR CONTROVERSIES ARISING OUT OF OR RELATING TO THESE TERMS OR THE APPLICABILITY, BREACH, TERMINATION, VALIDITY, ENFORCEMENT, OR INTERPRETATION OF THEM, OR TO THE USE OF THE SERVICES OR COMMUNICATIONS WITH UDEMY (COLLECTIVELY, “DISPUTES”) THAT ARE NOT RESOLVED INFORMALLY MUST BE ADDRESSED SOLELY IN SMALL CLAIMS COURT OR BY BINDING INDIVIDUAL ARBITRATION AND AGREE TO WAIVE THE RIGHT TO A JURY TRIAL AND TO FILE A CASE IN ANY OTHER COURT.

                YOU AND UDEMY FURTHER AGREE TO BRING CLAIMS AGAINST EACH OTHER IN AN INDIVIDUAL CAPACITY ONLY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY CLASS OR REPRESENTATIVE PROCEEDING WHETHER IN COURT OR IN ARBITRATION.

                You and Udemy agree that this Dispute Resolution Agreement applies to each of us as well as all of our respective agents, attorneys, contractors, subcontractors, service providers, employees, and all others acting for, or on behalf of, you and Udemy. This Dispute Resolution Agreement is binding on your and Udemy’s respective heirs, successors, and assigns, and is governed by the Federal Arbitration Act.

                11.2 Mandatory Informal Dispute Resolution Process
                Before filing a claim against each other, you and Udemy must first participate in the informal dispute resolution process described in this section.

                The claiming party shall send to the other a short, written statement (“Claim Statement”) with their full name, mailing address, and email address explaining: (a) the nature and details of the Dispute; and (b) a proposal for resolving it (including any money being claimed and how that amount was calculated). Sending a Claim Statement tolls the running of any applicable statute of limitations for a 60-day period beginning on the date the Claim Statement is received. You should send your Claim Statement to Udemy by email to notices@udemy.com, and you can also send it by certified mail to Udemy Attn: Legal, 600 Harrison Street, 3rd Floor, San Francisco, CA 94107. Udemy will send Claim Statements and respond to you at the email address associated with your Udemy account, unless you request otherwise.
                ...
                If 25 or more claimants (each a “Mass Arbitration claimant”) or their lawyers file or disclose an intention to file demands for arbitration against Udemy raising substantially identical Disputes, and counsel for the claimants are the same or coordinated across the Disputes (a “Mass Arbitration”), these special rules shall apply.
