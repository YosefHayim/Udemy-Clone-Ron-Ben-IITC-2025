  ...
  return (
    <div className="flex flex-col items-center bg-white  px-12 lg:flex-row">
      ...
      <div className="text-left lg:w-1/4">
        <h2 className="font-serif  text-[33px] font-bold leading-tight text-gray-900">
        ...
        <button className="mt-8 rounded-lg border border-gray-900 px-6 py-3 font-bold text-gray-900 transition duration-200 hover:bg-gray-100 focus:outline-none">
          Get the report →
        </button>
      </div>
