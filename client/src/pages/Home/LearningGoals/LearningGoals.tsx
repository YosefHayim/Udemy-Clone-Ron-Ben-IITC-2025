...
const LearningGoals = () => {
  ...
  return (
    <div className="items-center gap-8 bg-gray-50 px-8 py-16 lg:flex">
      {/* Features Section */}
      <div className="flex-1 space-y-6">
        ...
        {features.map((feature, index) => (
          ...
          >
            <img src={feature.image} alt={feature.title} className="mr-4 h-12 w-12" />
            <div>
              <h3
              ...
              {feature.badge && (
                <span className="mt-2 inline-block font-sans text-xs font-extrabold text-purple-600">
                  {feature.badge}
                </span>
              )}
              {feature.linkText && (
                <Link
                  to="#"
                  className="mt-2 inline-block font-sans text-sm font-extrabold text-purple-600"
                >
                  {feature.linkText}
                </Link>
              )}
      ...
      <div className="max-w-md flex-1">
        <div className="overflow-hidden rounded-lg bg-white shadow-md">
          <img src={containerizationImage} alt="Containerization analysis" className="w-full" />
        </div>
      </div>
    </div>
  );
