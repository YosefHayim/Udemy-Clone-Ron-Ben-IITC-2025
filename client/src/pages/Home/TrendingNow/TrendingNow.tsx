    ...
    <div className="bg-gray-100 px-12 py-16">
      ...
      <div className="mt-6 flex flex-col justify-between border-t border-gray-300 pt-6 lg:flex-row">
        ...
        <div className="mb-8 lg:mb-0 lg:w-1/4">
          ...
          <button className="mt-6 flex items-center space-x-2 rounded-lg border border-gray-900 px-6 py-3 font-extrabold text-gray-900 transition duration-200 hover:bg-gray-100 focus:outline-none">
        ...
        {/* Coluna 3 */}
        <div className="mb-8 lg:mb-0 lg:w-1/4">
          <h3 className="mb-4 text-lg font-extrabold text-gray-900">Design</h3>
          <div className="space-y-3">
            <Link
              to="/courses/blender"
              className="text-purple-600 hover:underline"
