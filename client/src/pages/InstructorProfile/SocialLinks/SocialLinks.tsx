...
const SocialLinks: React.FC<{
  ...
  return (
    <div className="flex w-full flex-col gap-[0.5em] text-btnColor">
      <div className="flex cursor-pointer  items-center justify-center gap-[0.5em] rounded-[0.2em] border border-btnColor py-[1em] text-center hover:bg-purpleHoverBtn">
