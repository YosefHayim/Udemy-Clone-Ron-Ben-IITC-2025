...
const getAllReports = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!reports || reports.length === 0) {
      return next(
        createError("No report documents found in the database", 404)
      );
    }
...
const getReportsByReviewId = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
...
const createReportByReviewId = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
...
const deleteReportById = catchAsync(
  async (req: Request, res: Response, next: NextFunction) => {
    const reportId = req.params.id;
